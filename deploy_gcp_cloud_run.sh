...
REPO="mcp-agent-repo"                 # The name for your Artifact Registry Docker repository.
IMAGE_NAME="mcp-agent-image"          # The name for your Docker image within the repository.
TAG="v6"                              # The tag for your Docker image (e.g., latest, v1, commit SHA).
...
ENV_MOUNT_PATH="/secrets/.env" # The absolute path inside the container where the .env file will be mounted.

SERVICE_NAME="mcp-agent"             # The name for your Cloud Run service.
